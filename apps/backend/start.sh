...
echo "- InsightFace: $(python -c 'import insightface; print(insightface.__version__)' 2>&1 || echo 'NOT FOUND - will use fallback ⚠️')"
echo "- ONNX Runtime: $(python -c 'import onnxruntime; print(onnxruntime.__version__)' 2>&1 || echo 'NOT FOUND ⚠️')"
