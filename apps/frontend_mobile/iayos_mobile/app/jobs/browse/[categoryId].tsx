          ...
          <View style={styles.jobHeader}>
            ...
            <View style={styles.budgetContainer}>
              <Text style={styles.budgetAmount}>
                {item.budget_range_min != null && item.budget_range_max != null
                  ? `₱${item.budget_range_min.toLocaleString()} - ₱${item.budget_range_max.toLocaleString()}`
                ...
                <View style={styles.teamJobProgressBar}>
                  <View
                    style={[
                      ...
                      { width: `${item.team_fill_percentage || 0}%` },
                    ]}
                  />
                </View>
                <Text style={styles.teamJobProgressText}>
                  {item.total_workers_assigned || 0}/
                  {item.total_workers_needed || 0} workers
                </Text>
              </View>
            </View>
          )}
