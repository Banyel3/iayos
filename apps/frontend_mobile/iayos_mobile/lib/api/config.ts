...
export const ENDPOINTS = {
  ...
  KYC_STAGE_FILE: `${API_URL}/api/accounts/kyc/stage-file`, // Per-file sequential staging endpoint
...
export const KYC_STAGE_FILE_TIMEOUT = 120000; // 2 minutes per individual file in sequential upload flow
