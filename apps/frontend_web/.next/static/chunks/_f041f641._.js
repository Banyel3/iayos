...
"[project]/apps/frontend_web/app/providers.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/frontend_web/components/ui/toast.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ToastProvider(param) {
    ...
    const showToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ToastProvider.useCallback[showToast]": (toast)=>{
            ...
            }["ToastProvider.useCallback[showToast]"], newToast.duration);
        }
    }["ToastProvider.useCallback[showToast]"], [
        removeToast
    ]);
...
function ToastItem(param) {
    ...
    const getToastStyles = ()=>{
        ...
        return "".concat(baseStyles, " ").concat(visibilityStyles, " ").concat(typeStyles[toast.type], " border rounded-lg shadow-lg p-4 mb-2 w-full");
    };
    const getIcon = ()=>{
        const iconMap = {
            success: "✓",
...
function useAuthToast() {
    ...
    const showAuthError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAuthToast.useCallback[showAuthError]": (message, title)=>{
            showToast({
                type: "error",
    ...
    }["useAuthToast.useCallback[showAuthError]"], [
        showToast
    ]);
    const showAuthSuccess = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAuthToast.useCallback[showAuthSuccess]": (message, title)=>{
            showToast({
                type: "success",
                title: title || "Success",
                message,
    ...
    }["useAuthToast.useCallback[showAuthSuccess]"], [
        showToast
    ]);
    return {
        showAuthError,
...
_s3(useAuthToast, "uYz+u8bHgIW1sGOGINc9rUhwnNs=", false, function() {
    return [
        useToast
    ];
});
...
"[project]/apps/frontend_web/context/AuthContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_f041f641._.js.map