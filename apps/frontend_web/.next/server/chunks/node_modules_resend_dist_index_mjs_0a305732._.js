...
function render(node) {
    return new Promise((resolve, reject)=>{
        __turbopack_context__.A("[project]/node_modules/@react-email/render/dist/node/index.mjs [app-route] (ecmascript, async loader)").then(({ render: render2 })=>{
            resolve(render2(node));
        }).catch(()=>{
            reject(Error("Failed to render React component. Make sure to install `@react-email/render`"));
        });
    });
}
// src/batch/batch.ts
var Batch = class {
    ...
    create(payload, options) {
        return __async(this, null, function*() {
            ...
            const data = yield this.resend.post("/emails/batch", emails, __spreadProps(__spreadValues({}, options), {
...
var Contacts = class {
    ...
    update(options) {
        return __async(this, null, function*() {
            ...
            const data = yield this.resend.patch(`/audiences/${options.audienceId}/contacts/${(options == null ? void 0 : options.email) ? options == null ? void 0 : options.email : options == null ? void 0 : options.id}`, {
