...
test.describe('Authentication Flows', () => {
  ...
  test.describe('Login Flow', () => {
    ...
    test('should successfully login as client', async ({ page }) => {
      ...
      await page.fill('input[type="password"]', TEST_CREDENTIALS.client.password);
      ...
      await expect(page.getByText(/dashboard|home/i)).toBeVisible({ timeout: 5000 });
    });
    ...
    test('should successfully login as worker', async ({ page }) => {
      ...
      await page.fill('input[type="password"]', TEST_CREDENTIALS.worker.password);
      await page.getByRole('button', { name: /sign in|login/i }).click();
    ...
    test('should show error for invalid credentials', async ({ page }) => {
      ...
      await expect(page.getByText(/invalid credentials|incorrect email or password/i)).toBeVisible({ timeout: 5000 });
    });
    ...
    test('should toggle password visibility', async ({ page }) => {
      ...
      await page.locator('button[aria-label*="password" i], svg.lucide-eye, svg.lucide-eye-off').first().click();
  ...
  test.describe('Registration Flow', () => {
    ...
    test('should validate password strength', async ({ page }) => {
      ...
      await page.fill('input[name="firstName"]', TEST_CREDENTIALS.new.firstName);
      await page.fill('input[name="lastName"]', TEST_CREDENTIALS.new.lastName);
      await page.fill('input[name="password"]', 'weak');
      
      // Should show password strength error
      await page.getByRole('button', { name: /sign up|create account|register/i }).click();
      await expect(page.getByText(/password must|at least 6 characters|strong password/i)).toBeVisible();
    });
