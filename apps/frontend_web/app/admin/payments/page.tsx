    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">${paymentData.totalRevenue.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{paymentData.totalTransactions.toLocaleString()}</div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardHeader>
            ...
            <CardDescription>Resolve payment disputes and chargebacks</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{paymentData.disputes}</div>
            <p className="text-xs text-muted-foreground mt-1">Active disputes to resolve</p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Refunds processed this month</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="flex gap-4 mb-6">
            ...
            <select
              value={statusFilter}
              onChange={(e) => setStatusFilter(e.target.value as "all" | "completed" | "pending" | "failed" | "disputed")}
