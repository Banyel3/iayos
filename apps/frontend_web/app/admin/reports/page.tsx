  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Download Count</CardTitle>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Generate reports for different aspects of the platform</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {[
              { name: "User Activity Report", desc: "User engagement and activity metrics" },
              { name: "Financial Report", desc: "Revenue, payments, and financial analytics" },
              { name: "Service Performance", desc: "Service provider performance metrics" },
              { name: "Customer Satisfaction", desc: "Reviews, ratings, and feedback analysis" }
            ].map((report, index) => (
