...
const AdminAgencyKYC = () => {
  ...
  const fetchSubmissions = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE}/api/adminpanel/agency-kyc${statusParam}`,
        {
          method: "GET",
          credentials: "include",
        },
  ...
  const handleReview = async (
    ...
    try {
      const res = await fetch(
        `${API_BASE}/api/adminpanel/agency-kyc/${submissionId}/review`,
        {
          method: "POST",
          credentials: "include",
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
        <div className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white rounded-2xl shadow-2xl">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-blue-100">
                  {selectedSubmission.account_email}
                </p>
              </div>
              <button
          ...
          <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  ...
                  <p className="text-gray-900">
                    {selectedSubmission.business_desc ||
              ...
              <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-gray-400">
                ...
                <div className="space-y-2">
                  <p className="text-sm text-gray-600">
                    ...
                    {selectedSubmission.reviewed_by_email || "Unknown"}
                  </p>
                  <p className="text-sm text-gray-600">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={
                      reviewAction === "REJECT"
                        ? "Explain why the submission is rejected (required)"
                        : "Optional feedback for the agency"
                    }
            ...
            {selectedSubmission.status !== "PENDING" && (
              <div
                className={`p-4 rounded-lg border-2 ${selectedSubmission.status === "APPROVED" ? "bg-green-50 border-green-200" : "bg-red-50 border-red-200"}`}
              >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-blue-100 mt-1">
                Verify agency identities and business documents
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-6">
            {[
              ...
              {
                label: "Approved",
                value: submissions.filter((s) => s.status === "APPROVED")
                  .length,
                color: "green",
              },
              {
