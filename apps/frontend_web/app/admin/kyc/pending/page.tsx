...
import { Clock, FileText, Search, CheckCircle, XCircle, Eye } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Pending KYC Reviews</h1>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {Math.round(pendingKYC.reduce((acc, r) => acc + r.daysPending, 0) / pendingKYC.length)}
            </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className={`text-lg font-semibold ${getDaysPendingColor(record.daysPending)}`}>
                      {record.daysPending}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-muted-foreground">Submitted</p>
                    <p className="text-sm">{new Date(record.submissionDate).toLocaleDateString()}</p>
                  </div>
      ...
      {filteredRecords.length === 0 && (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">No pending reviews found</h3>
            <p className="text-muted-foreground">
