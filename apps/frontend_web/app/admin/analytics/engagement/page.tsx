        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="border-0 shadow-xl hover:shadow-2xl transition-shadow">
            <CardContent className="p-6">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-1">8m 34s</h3>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-green-50 rounded-xl">
                  <div>
                    <p className="font-medium text-gray-900">Highly Engaged</p>
                    <p className="text-xs text-gray-500">
                      5+ sessions per week
                    </p>
                  </div>
                  <div className="text-right">
                    ...
                    <Badge className="bg-green-600 text-white mt-1">51%</Badge>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-xl">
                  <div>
                    <p className="font-medium text-gray-900">Low Engagement</p>
                    <p className="text-xs text-gray-500">
                      &lt;2 sessions per week
                    </p>
                  </div>
                  <div className="text-right">
                    <p className="text-2xl font-bold text-yellow-600">1,023</p>
                    <Badge className="bg-yellow-600 text-white mt-1">11%</Badge>
                  </div>
                </div>
