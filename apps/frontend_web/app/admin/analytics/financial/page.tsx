...
export default function FinancialReports() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <Sidebar />
      <div className="flex-1 min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-pink-50">
      {/* Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="border-0 shadow-xl hover:shadow-2xl transition-shadow">
            <CardContent className="p-6">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-1">₱2.85M</h3>
          ...
          <Card className="border-0 shadow-xl hover:shadow-2xl transition-shadow">
            <CardContent className="p-6">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-1">₱2.84M</h3>
          ...
          <Card className="border-0 shadow-xl">
            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  { category: "Construction", revenue: 926150, percentage: 33 },
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-green-50 rounded-xl">
                  ...
                  <div className="text-right">
                    ...
                    <Badge className="bg-green-600 text-white mt-1">35%</Badge>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">826 transactions</p>
                    </div>
                  </div>
                  <div className="text-right">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-orange-50 rounded-lg">
                    <p className="text-2xl font-bold text-orange-600">₱51.2K</p>
                    <p className="text-xs text-gray-600 mt-1">Total Refunded</p>
                  </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center p-6 bg-green-50 rounded-xl">
                <p className="text-3xl font-bold text-green-600 mb-2">₱2.71M</p>
                <p className="text-sm text-gray-600">Net Revenue</p>
                <p className="text-xs text-gray-500 mt-1">After refunds</p>
              </div>
              <div className="text-center p-6 bg-purple-50 rounded-xl">
                <p className="text-3xl font-bold text-purple-600 mb-2">₱222</p>
                <p className="text-sm text-gray-600">Revenue per User</p>
              </div>
              <div className="text-center p-6 bg-orange-50 rounded-xl">
                <p className="text-3xl font-bold text-orange-600 mb-2">₱690</p>
