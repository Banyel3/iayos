              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <option value="clients" className="text-gray-900">
                      Clients
                    </option>
                    <option value="workers" className="text-gray-900">
                      Workers
                    </option>
                    <option value="agencies" className="text-gray-900">
                      Agencies
                    </option>
                  </select>
                </div>
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all group overflow-hidden bg-white">
              <CardContent className="p-5 sm:p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Badge className="bg-blue-100 text-blue-700 border-0 font-black text-[10px] sm:text-xs uppercase tracking-widest">
                    DAU
                  </Badge>
                </div>
                ...
                <p className="text-[10px] sm:text-xs font-black text-gray-400 uppercase tracking-widest leading-none mb-4">
                  Daily Active Users
                </p>
                <div className="flex items-center gap-1.5 text-[10px] sm:text-xs font-black uppercase tracking-tight bg-gray-50 p-2 rounded-lg">
                  ...
                  <span
                    className={
                      dauGrowth >= 0 ? "text-emerald-600" : "text-red-600"
                    }
                  >
                    {dauGrowth >= 0 ? "+" : ""}
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all group overflow-hidden bg-white">
              <CardContent className="p-5 sm:p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Badge className="bg-green-100 text-green-700 border-0 font-black text-[10px] sm:text-xs uppercase tracking-widest">
                    WAU
                  </Badge>
                </div>
                <h3 className="text-2xl sm:text-3xl font-black text-gray-900 mb-1 tracking-tight">
                ...
                <div className="flex items-center gap-1.5 text-[10px] sm:text-xs font-black uppercase tracking-tight bg-gray-50 p-2 rounded-lg">
                  ...
                  <span
                    className={
                      wauGrowth >= 0 ? "text-emerald-600" : "text-red-600"
                    }
                  >
                    {wauGrowth >= 0 ? "+" : ""}
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all group overflow-hidden bg-white sm:col-span-2 lg:col-span-1">
              <CardContent className="p-5 sm:p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Badge className="bg-purple-100 text-purple-700 border-0 font-black text-[10px] sm:text-xs uppercase tracking-widest">
                    MAU
                  </Badge>
                </div>
                <h3 className="text-2xl sm:text-3xl font-black text-gray-900 mb-1 tracking-tight">
                ...
                <div className="flex items-center gap-1.5 text-[10px] sm:text-xs font-black uppercase tracking-tight bg-gray-50 p-2 rounded-lg">
                  ...
                  <span
                    className={
                      mauGrowth >= 0 ? "text-emerald-600" : "text-red-600"
                    }
                  >
                    {mauGrowth >= 0 ? "+" : ""}
                ...
                <table className="w-full text-[11px] sm:text-sm border-collapse min-w-[500px]">
                  <thead>
                    <tr className="border-b-2 border-gray-100">
                      <th className="text-left py-3 px-2 font-black text-gray-400 uppercase tracking-widest">
                        Cohort
                      </th>
                      <th className="text-center py-3 px-2 font-black text-gray-400 uppercase tracking-widest">
                        Day 1
                      </th>
                      <th className="text-center py-3 px-2 font-black text-gray-400 uppercase tracking-widest">
                        Day 7
                  ...
                  <tbody>
                    {(retentionCohorts.length > 0
                      ...
                      >
                        <td className="py-4 px-2 font-bold text-gray-700 uppercase">
                          {cohort.month}
                        </td>
            ...
            <CardContent className="p-4 sm:p-6 pt-0">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="text-center p-6 bg-orange-50 border-2 border-orange-100 rounded-2xl group hover:bg-orange-100 transition-all shadow-sm">
                  ...
                  <p className="text-[10px] sm:text-xs font-black text-gray-500 uppercase tracking-widest leading-none mb-3">
                    Monthly Churn
                  </p>
                  <Badge
