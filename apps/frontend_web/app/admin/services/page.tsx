...
const mockServices: Service[] = [
  {
    ...
    description: "Professional house cleaning services for residential properties",
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage all services offered on the platform</p>
        </div>
          ...
          <Card key={service.id} className="overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm text-gray-600">{service.reviewsCount} reviews</span>
              </div>
              
              <div className="flex justify-between items-center mb-3">
                <div>
                  <p className="text-sm text-gray-600">{service.providersCount} providers</p>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-gray-900">{formatPrice(service.price)}</p>
                  <p className="text-xs text-gray-500">
                    {service.price.type === "hourly" ? "per hour" : 
