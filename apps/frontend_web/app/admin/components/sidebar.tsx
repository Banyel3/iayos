  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: Archive,
        description: "Full verification history",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        icon: ClipboardList,
        description: "Open job posts",
      },
      {
        name: "Active",
        href: "/admin/jobs/active",
        icon: Clock,
        description: "In-progress jobs",
      },
      {
        name: "Completed",
    ...
    children: [
      {
        ...
        icon: Activity,
        description: "Platform KPIs & metrics",
      },
      {
        name: "Users",
...
export default function Sidebar({ className }: SidebarProps) {
  ...
  const navigationWithCount: NavItem[] = navigation.map((item) => {
    if (item.name === "Verification") {
      // Combined KYC + Certifications pending count
      const total = pendingKYCCount + pendingCertsCount;
      return {
        ...item,
